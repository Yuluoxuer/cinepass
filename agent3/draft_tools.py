"""agent3 购票草稿 Tools：读写中台 /booking-drafts/{sid}，与手动购票页面共用同一份草稿。

这样页面手动选的影片/影院/场次/座位，agent3 下一轮直接读取中台即是最新，无需 clientDraft 弥合。
"""
...
from agent3.http import backend_url, get, post
from agent3.booking_draft import get_session_id
