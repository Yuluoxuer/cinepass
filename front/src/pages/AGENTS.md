...
- Shared types for a page group go in a `types.ts` file within the group (e.g. `pages/system/types.ts`)
- Page components fetch their own data via `@/api/*` — do not put fetch logic directly in layout or component files
