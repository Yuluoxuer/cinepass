...
from agent4.tools.Http2BackendTools.auth import get_location
...
async def get_cinema(cinema_id: str) -> str:
    """查询指定影院详情。cinema_id=影院ID。返回原始 JSON 数据。"""
    try:
        validate_id(cinema_id, "cinema_id")
